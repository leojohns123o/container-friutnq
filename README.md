...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-friutnq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-friutnq.containers.anotherwebservice.com/
...
```
git clone git@github.com:leojohns123o/container-friutnq.git
cd container-friutnq
```
...
```
docker attach container-friutnq
```
